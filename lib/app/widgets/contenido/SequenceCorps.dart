...
import 'package:ccfs/app/widgets/contenido/sequences.dart';
import 'package:flutter/material.dart';

class CorpsSequence extends StatefulWidget {
  const CorpsSequence({super.key});

  @override
  State<CorpsSequence> createState() => _ExpresionxCorpsState();
}

class _ExpresionxCorpsState extends State<CorpsSequence> {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SequencexCorps(codCorps: corps),
          ),
        );
      },
      child: Container(
