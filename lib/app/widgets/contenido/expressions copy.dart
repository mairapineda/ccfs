...
import 'package:ccfs/app/widgets/contenido/expressionsList%20copy.dart';
import 'package:flutter/material.dart';

class ExpresionxCorps extends StatefulWidget {
  final PartieduCorps codCorps;

  const ExpresionxCorps({super.key, required this.codCorps});

  @override
  State<ExpresionxCorps> createState() => _ExpresionxCorpsState();
}

class _ExpresionxCorpsState extends State<ExpresionxCorps> {
  ...
  void initState() {
    super.initState();
    objExpression =
        misServicios.obtenerExpressionCorps(widget.codCorps.codCorps);
  }
